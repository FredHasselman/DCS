...
\NormalTok{for(i in }\DecValTok{1}\NormalTok{:}\DecValTok{50000}\NormalTok{)\{      }\CommentTok{# This takes some time: 20.000 iterations}
    ...
    \NormalTok{if(coor<=}\FloatTok{0.01}\NormalTok{)\{                  }\CommentTok{#This transformation 1% of the time}
        ...
        \NormalTok{y=}\FloatTok{0.16}\NormalTok{*y}
        \KeywordTok{points}\NormalTok{(x,y, }\DataTypeTok{pch=}\StringTok{"."}\NormalTok{, }\DataTypeTok{col=}\StringTok{"darkgreen"}\NormalTok{) }
    \NormalTok{\}}
    ...
    \NormalTok{if(}\KeywordTok{between}\NormalTok{(coor,}\FloatTok{0.01}\NormalTok{,}\FloatTok{0.08}\NormalTok{))\{   }\CommentTok{#This transformation 7% of the time}
        \NormalTok{x=}\FloatTok{0.2}\NormalTok{*x}\FloatTok{-0.26}\NormalTok{*y}
        \NormalTok{y=}\FloatTok{0.23}\NormalTok{*x}\FloatTok{+0.22}\NormalTok{*y}\FloatTok{+1.6}
        \KeywordTok{points}\NormalTok{(x,y, }\DataTypeTok{pch=}\StringTok{"."}\NormalTok{, }\DataTypeTok{col=}\StringTok{"darkolivegreen"}\NormalTok{) }
    \NormalTok{\}}
